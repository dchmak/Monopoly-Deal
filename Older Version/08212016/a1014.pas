...
//				#72, #80:
												...
												if card[pNo, pointer + 1] = 16 then
													case ch2 of
														...
														#32:	begin
																	...
																	pay(pNo, value * double, target, money, haveNo, denied);
																	double := 1;
																end;
													end
												else
	...
	//																	writeln(pointer2);
														...
														#32:		begin
																		...
																		case propchoice of
																			1:	case properties[pNo, propchoice] of
																					1:	pay(pNo, 2, 5, money, haveNo, denied);
																					2:	pay(pNo, 4, 5, money, haveNo, denied);
																					3:	pay(pNo, 7, 5, money, haveNo, denied);
																				end;
																			2:	case properties[pNo, propchoice] of
																					1:	pay(pNo, 3, 5, money, haveNo, denied);
																					2:	pay(pNo, 8, 5, money, haveNo, denied);
																				end;
																			3:	case properties[pNo, propchoice] of
																					1:	pay(pNo, 2, 5, money, haveNo, denied);
																					2:	pay(pNo, 3, 5, money, haveNo, denied);
																					3:	pay(pNo, 6, 5, money, haveNo, denied);
																				end;
																			4:	case properties[pNo, propchoice] of
																					1:	pay(pNo, 2, 5, money, haveNo, denied);
																					2:	pay(pNo, 4, 5, money, haveNo, denied);
																			...
																			5:	case properties[pNo, propchoice] of
																					1:	pay(pNo, 1, 5, money, haveNo, denied);
																					2:	pay(pNo, 3, 5, money, haveNo, denied);
																					3:	pay(pNo, 5, 5, money, haveNo, denied);
																				end;
																			6:	case properties[pNo, propchoice] of
																					1:	pay(pNo, 1, 5, money, haveNo, denied);
																					2:	pay(pNo, 2, 5, money, haveNo, denied);
																				end;
																			7:	case properties[pNo, propchoice] of
																					1:	pay(pNo, 1, 5, money, haveNo, denied);
																					2:	pay(pNo, 2, 5, money, haveNo, denied);
																					3:	pay(pNo, 3, 5, money, haveNo, denied);
																				end;
																			8:	case properties[pNo, propchoice] of
																					1:	pay(pNo, 1, 5, money, haveNo, denied);
																					2:	pay(pNo, 2, 5, money, haveNo, denied);
																					3:	pay(pNo, 4, 5, money, haveNo, denied);
																				end;
																			9:	case properties[pNo, propchoice] of
																					1:	pay(pNo, 1, 5, money, haveNo, denied);
																					2:	pay(pNo, 2, 5, money, haveNo, denied);
																			...
																			10:	case properties[pNo, propchoice] of
																					...
																					2:	pay(pNo, 2, 5, money, haveNo, denied);
																					3:	pay(pNo, 3, 5, money, haveNo, denied);
																					4:	pay(pNo, 4, 5, money, haveNo, denied);
																				end;
																		end;
																	end;
													end;
