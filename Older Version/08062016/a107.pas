...
procedure display(pNo: integer; var card: cardtype; var cardNo: cardNotype; var money: cardNotype; var properties: propertytype);
var
	i, j, k: integer;
	info: string;
	cardinfo: text;
...
var
	...
	i, j, pNo, pointer, action, propchoice: integer;
	cardlist: text;
	win: boolean;
	ch: char;
begin
...
//		card[3,i] := 0;
	...
	repeat	
		...
		display(pNo, card, cardNo, money, properties);
				...
				#32:	begin									//  (space)
							...
							case card[pNo, pointer + 1] of
								...
								17..34:	begin																			//property
											...
											begin
												writeln('wildcard required an update');
											end
											else
												propchoice := card[pNo, pointer + 1] - 16;
												
											if properties[pNo, propchoice] < deck[card[pNo, pointer + 1], 2] then
                                            begin
