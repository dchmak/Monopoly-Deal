...
type
	...
	moneytype = array[1..4, 1..21] of byte;	{player, 1-20: types of money, 21: how many types of money}
...
//												writeln(properties[pNo, propchoice]);	readln;
								...
								35..40:	begin																			//money
											if card[pNo, pointer + 1] = 35 then
												money[pNo, money[pNo, 21] + 1] := 10
											else
												money[pNo, money[pNo, 21] + 1] := 41 - card[pNo, pointer + 1];
											money[pNo, 21] := money[pNo, 21] + 1;
										end;
							end;
